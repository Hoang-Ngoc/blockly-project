...
Blockly.JavaScript['lcd_display'] = function (block) {
...
Blockly.JavaScript['oled_display'] = function (block) {
  var dropdown_port_1 = block.getFieldValue('pin1');
  if(dropdown_port_1 == 'Pin 8')
  {
    var pin_1 = 8;
...
Blockly.JavaScript['buzzer_beep'] = function (block) {
  var dropdown_port = block.getFieldValue('Port');
  var time = Blockly.JavaScript.valueToCode(block, 'TIME', Blockly.JavaScript.ORDER_NONE) || '0';
...
Blockly.JavaScript['srf05_IoT'] = function (block) {
  var dropdown_port_1 = block.getFieldValue('pin1');
  if (dropdown_port_1 == 'Pin 15') var pin1 = 15;
...
Blockly.JavaScript['infread_sensor'] = function (block) {
  var dropdown_port = block.getFieldValue('pin');
...
Blockly.JavaScript['rain_sensor'] = function (block) {
  var dropdown_port = block.getFieldValue('pin');
  if (dropdown_port == 'Pin 11') var pin = 11;
...
Blockly.JavaScript['gas_sensor'] = function (block) {
  var dropdown_port = block.getFieldValue('pin');
  if (dropdown_port == 'Pin 2') var pin = 2;
...
Blockly.JavaScript['soil_sensor'] = function (block) {
  var dropdown_port = block.getFieldValue('pin');
  if (dropdown_port == 'Pin 40') var pin = 40;
...
Blockly.JavaScript['light_sensor_IoT'] = function (block) {
  var dropdown_port = block.getFieldValue('pin');
  if (dropdown_port == 'Pin 17') var pin = 17;
...
Blockly.JavaScript['sound_sensor_IoT'] = function (block) {
  var dropdown_port = block.getFieldValue('pin');
