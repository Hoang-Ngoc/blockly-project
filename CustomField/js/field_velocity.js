...
//contructor
CustomFields.FieldVelocity = function (
  opt_value,
  opt_min,
  opt_max,
  opt_precision,
  ...
  CustomFields.FieldVelocity.superClass_.constructor.call(
    this,
    opt_value,
    opt_min,
    opt_max,
...
CustomFields.FieldVelocity.fromJson = function (options) {
  return new CustomFields.FieldVelocity(
    options['value'],
    undefined,
    undefined,
    undefined,
...
CustomFields.FieldVelocity.prototype.CreateWidget_ = function () {
  ...
  this.listener_ = Blockly.bindEvent_(
    knod,
    this.getMouseDown(),
    this,
    this.onMouseDown,
...
CustomFields.FieldVelocity.prototype.createTicks = function (
  tickContainer,
  numTicks,
  highlightNumTicks,
) {
