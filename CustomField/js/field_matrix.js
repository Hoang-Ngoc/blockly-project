...
CustomFields.FieldMatrix = function (
  R1,
  R2,
  R3,
  R4,
  ...
  var value = {};
  value.R1 = R1 || 'false,false,false,false,false,false,false,false';
  value.R2 = R2 || 'false,false,false,false,false,false,false,false';
  value.R3 = R3 || 'false,false,false,false,false,false,false,false';
  value.R4 = R4 || 'false,false,false,false,false,false,false,false';
  value.R5 = R5 || 'false,false,false,false,false,false,false,false';
  value.R6 = R6 || 'false,false,false,false,false,false,false,false';
  value.R7 = R7 || 'false,false,false,false,false,false,false,false';
  value.R8 = R8 || 'false,false,false,false,false,false,false,false';

  CustomFields.FieldMatrix.superClass_.constructor.call(
    this,
    value,
    opt_validator,
  );
...
CustomFields.FieldMatrix.prototype.doClassValidation_ = function (newValue) {
  if (newValue.R1 == undefined || newValue.R1 > 255 || newValue.R1 < 0) {
    newValue.R1 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R2 == undefined || newValue.R2 > 255 || newValue.R2 < 0) {
    newValue.R2 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R3 == undefined || newValue.R3 > 255 || newValue.R3 < 0) {
    newValue.R3 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R4 == undefined || newValue.R4 > 255 || newValue.R4 < 0) {
    newValue.R4 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R5 == undefined || newValue.R5 > 255 || newValue.R5 < 0) {
    newValue.R5 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R6 == undefined || newValue.R6 > 255 || newValue.R6 < 0) {
    newValue.R6 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R7 == undefined || newValue.R7 > 255 || newValue.R7 < 0) {
    newValue.R7 = 'false,false,false,false,false,false,false,false';
  }
  if (newValue.R8 == undefined || newValue.R8 > 255 || newValue.R8 < 0) {
    newValue.R8 = 'false,false,false,false,false,false,false,false';
  }
  return newValue;
};
...
CustomFields.FieldMatrix.prototype.onMouseMove = function (event) {
  ...
  if (this.curEl_ != curEl && curEl.className == 'cell') {
    ...
    if (
      ...
      !this.curEl_.style.backgroundColor
    ) {
      this.curEl_.style.backgroundColor = '#a8d8f8';
      let newRow = arrayLed[r - 1].split(',').map(v => v !== 'false');
      newRow[c - 1] = true;
      arrayLed[r - 1] = newRow.join(',');
    } else {
      this.curEl_.style.backgroundColor = 'transparent';
      let newRow = arrayLed[r - 1].split(',').map(v => v !== 'false');
      newRow[c - 1] = false;
